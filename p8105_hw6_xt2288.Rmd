...
`r sum(is.na(pull(weather_data_df,log_b1_b2)))/nrow(weather_data_df)`% is NA. After removed these NAs. The distribution of log($\hat{\beta_1} * \hat{\beta_2}$) is left-skewed.
