...
```
    ...
    ## Warning: Removed 3346 rows containing non-finite values (`stat_density()`).

![](p8105_hw6_xt2288_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->

66.92% is NA. After removed these NAs. The distribution of
...
```
    ...
    ## Warning: There was 1 warning in `mutate()`.
    ## ℹ In argument: `rmse_model_1 = map2_dbl(model_1, test, function(mod, df)
...
![](p8105_hw6_xt2288_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
